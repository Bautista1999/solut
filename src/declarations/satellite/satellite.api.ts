...
import type {_SERVICE as SatelliteActor, Idea, Milestone, Notification, PledgeData, Product, SetIdea, Solution, Result, Result_1, Result_2, Result_3} from './satellite.did';
