...
import type {_SERVICE as SatelliteActor, Activity, Idea, IndexResponse, IndexResponseBasicInfo, Milestone, Notification, PledgeData, Product, SetIdea, Solution, UserBasicInfo, UserProfileBasicInfo, Result, Result_1, Result_10, Result_2, Result_3, Result_4, Result_5, Result_6, Result_7, Result_8, Result_9} from './satellite.did';
