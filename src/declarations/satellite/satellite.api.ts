...
import type {_SERVICE as SatelliteActor, Activity, EnrichedPledgeData, Idea, IndexResponse, IndexResponseBasicInfo, Milestone, Notification, PledgeData, Product, SetIdea, Solution, UserBasicInfo, UserProfileBasicInfo, Result, Result_1, Result_10, Result_11, Result_2, Result_3, Result_4, Result_5, Result_6, Result_7, Result_8, Result_9} from './satellite.did';
...
export const getFundingDetails = async (value0: string, value1: string): Promise<Result_3> => {
...
export const getHistoricalPledgedBalance = async (value0: string): Promise<Result_2> => {
...
export const getPaginatedCommonUsers = async (value0: string, value1: string, value2: unknown, value3: unknown): Promise<Result_4> => {
...
export const getPaginatedFollowers = async (value0: string, value1: unknown, value2: unknown): Promise<Result_5> => {
...
export const getPaginatedFollowingElements = async (value0: string, value1: unknown, value2: unknown): Promise<Result_5> => {
...
export const getPaginatedIdeas = async (value0: string, value1: unknown, value2: unknown, value3: unknown, value4: unknown): Promise<Result_6> => {
...
export const getPaginatedIdeasBySolution = async (value0: string, value1: unknown, value2: unknown, value3: unknown, value4: string): Promise<Result_6> => {
...
export const getPaginatedMostRecentActivities = async (value0: string, value1: unknown, value2: unknown): Promise<Result_7> => {
...
export const getPaginatedTopics = async (value0: string, value1: unknown, value2: unknown, value3: unknown): Promise<Result_6> => {
...
export const getPaginatedTopicsIdeas = async (value0: string, value1: unknown, value2: unknown, value3: unknown): Promise<Result_6> => {
...
export const getPaginatedUsers = async (value0: string, value1: unknown, value2: unknown, value3: unknown): Promise<Result_6> => {
...
export const getTotalPledgedAndExpected = async (value0: string, value1: string): Promise<Result_8> => {
...
export const getUserActivePledges = async (value0: string): Promise<Result_9> => {
...
export const getUserTotalPledges = async (value0: string): Promise<Result_9> => {
