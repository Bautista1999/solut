...
import type {_SERVICE as SatelliteActor, Idea, IndexResponse, Milestone, Notification, PledgeData, Product, SetIdea, Solution, Result, Result_1, Result_2, Result_3, Result_4, Result_5, Result_6} from './satellite.did';
...
export const getPaginatedIdeas = async (value0: string, value1: unknown, value2: unknown, value3: unknown, value4: unknown): Promise<Result_4> => {
...
export const getPaginatedIdeasBySolution = async (value0: string, value1: unknown, value2: unknown, value3: unknown, value4: string): Promise<Result_4> => {
...
export const getPaginatedTopics = async (value0: string, value1: unknown, value2: unknown, value3: unknown): Promise<Result_4> => {
...
export const getPaginatedTopicsIdeas = async (value0: string, value1: unknown, value2: unknown, value3: unknown): Promise<Result_4> => {
...
export const getPaginatedUsers = async (value0: string, value1: unknown, value2: unknown, value3: unknown): Promise<Result_4> => {
...
export const getTotalPledgedAndExpected = async (value0: string, value1: string): Promise<Result_5> => {
...
export const getUserActivePledges = async (value0: string): Promise<Result_6> => {
